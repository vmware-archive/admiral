...
public class ContainerMultiNetworkingIT extends BaseProvisioningOnCoreOsIT {
    ...
    public void testProvision() throws Exception {
        // the test uses clustered hosts to avoid bridge networks, which fail sporadically
        doProvisionDockerContainerOnCoreOS(false, DockerAdapterType.API, true, NUMBER_OF_NETWORKS);
    }
