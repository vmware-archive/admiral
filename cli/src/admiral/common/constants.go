...
const (
	...
	ClosureDescriptionFilterID = "/resources/closure-descriptions?documentType=true&$count=true&$limit=19&$orderby=&$filter=documentSelfLink+eq+"
	...
	ClosureDescriptionFilterName = "/resources/closure-descriptions?documentType=true&$count=true&$limit=19&$orderby=&$filter=name+eq+"
