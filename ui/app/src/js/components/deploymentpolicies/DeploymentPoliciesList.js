...
var DeploymentPoliciesList = Vue.extend({
  ...
  attached: function() {
    ...
    var list = InlineEditableListFactory.createDeploymentPoliciesList($listHolder);
...
Vue.component('deployment-policies-list', DeploymentPoliciesList);

export default DeploymentPoliciesList;
