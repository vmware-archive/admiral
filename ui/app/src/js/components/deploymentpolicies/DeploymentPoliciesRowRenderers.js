...
var renderers = {
  render: function(deploymentPolicyHolder) {
    var $el = $(DeploymentPoliciesRowTemplate(deploymentPolicyHolder));
  ...
  renderHighlighted: function(deploymentPolicyHolder, $deploymentPolicyHolderRow,
      isNew, isUpdated, validationErrors) {
    var additionalProps = {
      isNew: isNew,
      isUpdated: isUpdated,
      validationErrors: validationErrors,
      deploymentPoliciesRow: $deploymentPolicyHolderRow.html()
    };

    var model = $.extend({}, deploymentPolicyHolder, additionalProps);

    return $(DeploymentPoliciesRowHighlightTemplate(model));
  }
};
