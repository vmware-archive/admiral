...
import AzureStorageAccountsListVue from
  'components/profiles/azure/AzureStorageAccountsListVue.html';
import { AzureStorageAccountsActions } from 'actions/Actions';
import AzureStorageAccountEditor from //eslint-disable-line
  'components/profiles/azure/AzureStorageAccountEditor';

export default Vue.component('azure-storage-accounts-list', {
  template: AzureStorageAccountsListVue,
  props: {
    model: {
      type: Object,
      required: true
  ...
  methods: {
    ...
    editItem(item, $event) {
      ...
      AzureStorageAccountsActions.editAccount(item);
    },
    refresh() {
