...
import ListTitleBigVue from 'components/common/ListTitleBigVue.html';

var ListTitleBigVueComponent = Vue.extend({
  template: ListTitleBigVue,
  props: {
    hasSearchQuery: {
      required: false,
      type: Boolean,
...
Vue.component('list-title-big', ListTitleBigVueComponent);

export default ListTitleBigVueComponent;
