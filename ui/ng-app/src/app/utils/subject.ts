...
/**
 * Abstract base class for any subjects to be used int he application. Subject
 * are similar entities like Stores in Reflux using ReplaySubject(1) from RxJS.
 *
 * @abstract
 * @class Subject
...
export abstract class Subject < T > {
  ...
  /**
   * Method to be implemented in subclasses that puts together the payload
   * of the subject when it notifies the subscribes the next time.
   *
   * @protected
   * @abstract
