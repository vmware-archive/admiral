...
var ARROW_UP = '\uf062';
var ARROW_DOWN = '\uf063';
var ARROW_UP_SVG = document.createElementNS('http://www.w3.org/2000/svg', 'tspan');
ARROW_UP_SVG.setAttribute('class', 'arrow');
ARROW_UP_SVG.textContent = ARROW_UP;
var ARROW_DOWN_SVG = document.createElementNS('http://www.w3.org/2000/svg', 'tspan');
...
var duration = 1000;
var labelHolderWidth = 120;
var labelHolderHeight = 150;
var labelHolderY = labelHolderWidth + 24;
module.exports = (function () {
    function NetworkTrafficVisualization(parent, i18n) {
        ...
        configureIOLabels(labels, 'network-traffic-received-label', i18n.t('app.container.details.networkTrafficReceived'), true);
        ...
        separator.append('text')
            ...
            .text('/');
        configureIOLabels(labels, 'network-traffic-sent-label', i18n.t('app.container.details.networkTrafficSent'), false);
    }
    NetworkTrafficVisualization.prototype.setData = function (receivedBytes, sentBytes) {
    ...
    NetworkTrafficVisualization.prototype.reset = function (label) {
    ...
    return NetworkTrafficVisualization;
}());
...
//# sourceMappingURL=NetworkTrafficVisualization.js.map