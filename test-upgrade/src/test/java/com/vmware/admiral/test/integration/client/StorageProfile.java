...
@XmlRootElement(name = "DeploymentStorageProfile")
@XmlAccessorType(XmlAccessType.FIELD)
@JsonIgnoreProperties(ignoreUnknown = true)
@DcpDocumentKind("com:vmware:admiral:compute:env:StorageProfileService:StorageProfile")
public class StorageProfile extends TenantedServiceDocument {
