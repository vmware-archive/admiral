...
@XmlRootElement(name = "DeploymentComputeProfile")
@XmlAccessorType(XmlAccessType.FIELD)
@JsonIgnoreProperties(ignoreUnknown = true)
@DcpDocumentKind("com:vmware:admiral:compute:env:ComputeProfileService:ComputeProfile")
public class ComputeProfile extends TenantedServiceDocument {
