...
@DcpDocumentKind("com:vmware:admiral:compute:env:EnvironmentService:EnvironmentStateExpanded")
public class EnvironmentStateExpanded extends EnvironmentState {
