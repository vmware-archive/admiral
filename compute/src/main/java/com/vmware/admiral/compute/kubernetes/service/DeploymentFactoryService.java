 ...
 */
public class DeploymentFactoryService extends AbstractSecuredFactoryService {
    public static final String SELF_LINK = ManagementUriParts.KUBERNETES_DEPLOYMENTS;

    public DeploymentFactoryService() {
        super(DeploymentService.DeploymentState.class);
    }
