 ...
 * 'external' cannot be used in conjunction with other volume configuration keys (driver,
 * driver_opts).
 *
 ...
 */
@JsonDeserialize(using = VolumeExternalDeserializer.class)
@JsonSerialize(using = VolumeExternalSerializer.class)
public class VolumeExternal {
