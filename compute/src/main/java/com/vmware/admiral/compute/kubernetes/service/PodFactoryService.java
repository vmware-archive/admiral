 ...
 * {@link PodService}.
 */
public class PodFactoryService extends AbstractSecuredFactoryService {
    public static final String SELF_LINK = ManagementUriParts.KUBERNETES_PODS;

    public PodFactoryService() {
        super(PodService.PodState.class);
    }
