...
public class PKSEndpointFactoryService extends AbstractSecuredFactoryService {

    public static final String SELF_LINK = ManagementUriParts.PKS_ENDPOINTS;

    public PKSEndpointFactoryService() {
        super(Endpoint.class);
    }

    @Override
    public Service createServiceInstance() throws Throwable {
        return new PKSEndpointService();
    }
