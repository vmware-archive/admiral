...
import com.vmware.admiral.adapter.pks.service.PKSPlanListService;
...
public class HostInitKubernetesAdapterServiceConfig {
    public static void startServices(ServiceHost host, boolean startMockHostAdapterInstance) {
        if (startMockHostAdapterInstance) {
            ...
            host.startService(
                    Operation.createPost(UriUtils.buildUri(host, PKSPlanListService.class)),
                    new PKSPlanListService());
            host.startService(
