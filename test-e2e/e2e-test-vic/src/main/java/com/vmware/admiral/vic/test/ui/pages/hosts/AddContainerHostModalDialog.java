...
public class AddContainerHostModalDialog extends AddClusterModalDialog {

    public AddContainerHostModalDialog(By[] iFrameLocators,
            AddContainerHostModalDialogValidator validator,
