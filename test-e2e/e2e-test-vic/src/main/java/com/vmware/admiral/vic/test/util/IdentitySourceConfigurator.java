...
public class IdentitySourceConfigurator {
    ...
    public IdentitySourceConfigurator(String vcenterTarget, String vcenterUsername,
            String vcenterPassword) {
        if (!vcenterTarget.startsWith("https://")) {
            this.TARGET = "https://" + vcenterTarget;
        } else {
            this.TARGET = vcenterTarget;
        }
