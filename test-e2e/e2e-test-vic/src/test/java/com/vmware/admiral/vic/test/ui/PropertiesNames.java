...
public class PropertiesNames {
    ...
    public static final String PROPERTIES_FILE_NAME = "vic-ui-test.properties";
    ...
    public static final String DEFAULT_ADMIN_PASSWORD_PROPERTY = "default.administrator.password";
