...
public class CredentialsTabValidator extends PageValidator<CredentialsTabLocators> {

    public CredentialsTabValidator(By[] iFrameLocators, CredentialsTabLocators pageLocators) {
