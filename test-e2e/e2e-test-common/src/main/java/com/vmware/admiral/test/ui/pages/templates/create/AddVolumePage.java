...
public class AddVolumePage extends CreateVolumePage {

    public AddVolumePage(By[] iFrameLocators, AddVolumePageValidator validator,
            AddVolumePageLocators pageLocators) {
